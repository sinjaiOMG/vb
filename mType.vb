...
Public Class mType
    ...
    Sub connect()
        ...
        Catch ex As Exception
            ...
            With ms
                .Label2.Text = "ບໍ່ສາມາດເຊື່ອມຕໍ່ຖາມຂໍ້ມູນ"
                .ShowDialog()
            End With
        End Try
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Try
                sql = "insert into Medicine_Type values(N'" & TextBox2.Text & "',N'" & TextBox3.Text & "')"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        connect()
        Try
            sql = "update Medicine_Type set name = N'" & TextBox3.Text & "' WHERE MTID = N'" & TextBox2.Text & "'"
            cmd = New SqlCommand(sql, cn)
            cmd.ExecuteNonQuery()
        Catch ex As Exception
            With ms
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        With YESorNO
            ...
            If .Label4.Text = "ຢືນຢັນ" Then
                Try
                    sql = "Delete from Medicine_Type where MTID = '" & (TextBox2.Text) & "'"
                    cmd = New SqlCommand(sql, cn)
                    cmd.ExecuteNonQuery()
                Catch ex As Exception
                    With ms
    ...
    Private Sub ShowServiceData()
        connect()
        sql = "select MTID,name from Medicine_Type"
        da = New SqlClient.SqlDataAdapter(sql, cn)
        ds = New DataSet
        da.Fill(ds, "Medicine_Type")
        DataGridView1.DataSource = ds
        DataGridView1.DataMember = "Medicine_Type"
        FormatDGVStyleStock()
    End Sub
    Private Sub FormatDGVStyleStock()
        ...
        With DataGridView1
            ...
            .Columns(0).HeaderText = "ລະຫັດຊະນິດ"
            .Columns(1).HeaderText = "ຊື່ຊະນິດ"
    ...
    Private Sub AutoID()
        sql = "Select max(MTID) from Medicine_Type"
        cmd = New SqlCommand(sql, cn)
        Try
        ...
        ShowServiceData()
    End Sub
    Private Sub mType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
