...
Public Class service
    ...
    Private Sub AutoID()
        sql = "Select max(SID) from Service"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Try
                sql = "insert into Service values(N'" & TextBox2.Text & "',N'" & TextBox3.Text & "')"
                cmd = New SqlCommand(sql, cn)
                cmd.ExecuteNonQuery()
    ...
    Private Sub ShowServiceData()
        connect()
        sql = "select SID,name from Service"
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        connect()
        Try
            sql = "update Service set name = N'" & TextBox3.Text & "' WHERE SID = N'" & TextBox2.Text & "'"
            cmd = New SqlCommand(sql, cn)
            cmd.ExecuteNonQuery()
        Catch ex As Exception
            With ms
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        With YESorNO
            ...
            If .Label4.Text = "ຢືນຢັນ" Then
                ...
                Try
                    sql = "Delete from Service where SID = '" & (TextBox2.Text) & "'"
                    cmd = New SqlCommand(sql, cn)
                    cmd.ExecuteNonQuery()
                Catch ex As Exception
                    With ms
    ...
    Public Sub FilterData(valueToSearch As String)
        Dim searchQuery As String = "SELECT * FROM Service WHERE CONCAT(SID,name) like N'%" & valueToSearch & "%' "
