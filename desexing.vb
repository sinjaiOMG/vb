...
Public Class positionEMP
    ...
    'Private Sub AutoID()
    '    sql = "Select max(PID) from Position"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        With YESorNO
            ...
            If .Label4.Text = "ຢືນຢັນ" Then
                Try
                    sql = "Delete from Position where PID = '" & (TextBox2.Text) & "'"
                    cmd = New SqlCommand(sql, cn)
                    cmd.ExecuteNonQuery()
                Catch ex As Exception
                    With ms
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            Try
                sql = "insert into Position values(N'" & TextBox2.Text & "',N'" & TextBox3.Text & "')"
                cmd = New SqlCommand(sql, cn)
                cmd.ExecuteNonQuery()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        connect()
        Try
            sql = "update Position set name = N'" & TextBox3.Text & "' WHERE PID = N'" & TextBox2.Text & "'"
            cmd = New SqlCommand(sql, cn)
            cmd.ExecuteNonQuery()
        Catch ex As Exception
            With ms
    ...
    Private Sub AutoID()
        ...
        ShowServiceData()
    End Sub
    Private Sub positionEMP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ShowServiceData()
        connect()
        sql = "select PID,name from Position"
    ...
    Public Sub FilterData(valueToSearch As String)
        Dim searchQuery As String = "SELECT * FROM Position WHERE CONCAT(PID,name) like N'%" & valueToSearch & "%' "
